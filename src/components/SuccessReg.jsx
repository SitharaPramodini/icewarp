...
const SuccessReg = () => {
  return (
    <div>
        ...
        <h1 class="keyboard text-center text-[40px] mt-12 mb-[-8px]">Hello Buddhini!</h1>
...
<h1 class="mb-4 text-center text-2xl font-medium text-gray-700 mt-10 ">Your table no: 10</h1>
